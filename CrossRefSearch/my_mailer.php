<?php
function my_mailer($title,$url,$item,$person,$person_email) {
	...
	$mail->CharSet = 'UTF-8';
	$mail->setFrom(SUPPORT, 'xx');           ## You can change "xx" to some team or person name if you want. Shows up in emails
	$mail->addAddress(RECIPIENT, 'xx');     
	$mail->addAddress(SUPPORT, 'xx');   	  
	$mail->addReplyTo(SUPPORT, 'xx');      
	
	$mail->isHTML(true);                                  // Set email format to HTML
	
	$mail->Subject = $shorttitle;
